...
function App() {
  ...
  const portfolioItems = [
    { id: 1, title: 'Cyberpunk Alleyway', category: 'Urban Environment', engine: 'UNITY', artist: 'Nidhal Zitouni', image: 'https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?q=80&w=2070&auto=format&fit=crop', description: 'Interactive cyberpunk alleyway designed with Unity High Definition Render Pipeline (HDRP). Features fully dynamic neon lighting, customized shaders, and highly optimized mesh assets.' },
    { id: 2, title: 'Bioluminescent Forest Ruins', category: 'Natural Environment', engine: 'GODOT', artist: 'Nidhal Zitouni', image: 'https://images.unsplash.com/photo-1500627869374-13cd993b1115?q=80&w=2070&auto=format&fit=crop', description: 'Lush, stylized fantasy ruins created in Godot 4. Includes custom particle effects, wind vertex displacement for foliage, and optimized performance for low-end hardware.' },
    { id: 3, title: 'Medieval Gothic Cathedral', category: 'Gothic Architecture', engine: 'UNREAL', artist: 'Nidhal Zitouni', image: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?q=80&w=2070&auto=format&fit=crop', description: 'Highly detailed medieval cathedral interior utilizing Unreal Engine 5 Nanite and Lumen global illumination. Built with modular architectural kits.' },
    { id: 4, title: 'Mech Assembly Hangar', category: 'Hard-Surface Showcase', engine: 'UNITY', artist: 'Nidhal Zitouni', image: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?q=80&w=2070&auto=format&fit=crop', description: '3D environment and assembly line for mechs, optimized for real-time mobile gameplay using Unity URP. Features baked lightmaps and customized visual effects.' },
    { id: 5, title: 'Sunken Temple Depths', category: 'Underwater Level Design', engine: 'GODOT', artist: 'Nidhal Zitouni', image: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?q=80&w=2070&auto=format&fit=crop', description: 'Submerged dungeon explorer featuring caustics shaders, volumetric water lights, and custom level layout templates optimized for Godot\'s forward+ renderer.' },
    { id: 6, title: 'Lunar Base Outpost', category: 'Sci-Fi Space Environment', engine: 'UNREAL', artist: 'Nidhal Zitouni', image: 'https://images.unsplash.com/photo-1614728894747-a83421e2b9c9?q=80&w=2070&auto=format&fit=crop', description: 'Cinematic moon base exterior created in Unreal Engine 5. Focuses on advanced landscape materials, terrain blending, and volumetric fog systems.' },
  ];
    ...
    <main className="min-h-screen max-w-6xl mx-auto px-5 sm:px-8 py-5 relative z-10">
      ...
      <div id="portfolio" className="py-6 fade-in fade-in-d4">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {['all', 'UNITY', 'GODOT', 'UNREAL'].map((cat) => (
